package com.github.mgljava.processor;

import com.github.mgljava.entity.ClassEntity;
import com.github.mgljava.entity.FieldEntity;
import com.github.mgljava.utils.StringUtils;
...
public class JsonProcessor {
  ...
  private void parse(String key, JsonElement root, ClassEntity rootModel, boolean addFieldToRoot) {
    ...
    if (root.isJsonObject()) {
      ...
      parseArray(root.getAsJsonArray(), StringUtils.dealMiddleLine(key), arrayFieldEntity, "List<>");
    }
  }
